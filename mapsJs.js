function initMap(){
  ...
  addMarker({
    ...
    $('.story').on('click', function zoies(latt,logg){
// parse lat and lng from the divs data attribute  
            map.setCenter({lat:latt, lng:logg});
            map.setZoom(15);
        })
}
